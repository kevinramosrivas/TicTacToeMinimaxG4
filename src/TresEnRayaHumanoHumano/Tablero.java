...
public class Tablero extends javax.swing.JFrame {
    ...
    String Jugador1 = DtHH.Nombre1;
    String Jugador2 = DtHH.Nombre2;
    
    TresEnRaya tresEnRaya3 = new TresEnRaya();
    
    String turno = "X";
    String juega =  Jugador1;
    ...
    private void initComponents() {
        ...
        lbturno.setText("Turno de "+ Jugador1);

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText(Jugador1 + "= ");

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText(Jugador2+"= ");
        ...
        for(int i=0;i<vs.length;i++){
            if(lbs[vs[i][0]-1].getText().equals("X")&&
               ...
               lbs[vs[i][2]-1].getText().equals("X")){
                   ...
                   lbturno.setText("Ha ganado "+Jugador1);
                   estado=false;
            }
            ...
            if(lbs[vs[i][0]-1].getText().equals("O")&&
               ...
               lbs[vs[i][2]-1].getText().equals("O")){
                   ...
                   lbturno.setText("Ha ganado "+ Jugador2);
                   estado=false;
            }
        }
    }
